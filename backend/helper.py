...
def prepare_prompt(resume_text, job_description):
    ...
    "Respond ONLY with JSON. Do not include markdown, explanations, or additional comments. JSON only."
    ...
    {{
        ...
        "Profile Summary": "detailed analysis of the match and specific improvement suggestions in 200 words"
